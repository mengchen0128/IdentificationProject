...
def Instant_AmpOmega_Extraction_Sliding(t,u,Omeg_Mean,Slide_Ratio,N_Period,Para0):
    ...
    for n in range(0, N_T-1):
        ...
        popt,pcov= curve_fit(myfun, var1, var2, p0=Para0,bounds=(LB,UB))
...
if __name__ == '__main__':
   ...
   plt.plot(a[0],a[1])
   plt.show()
   para = [3, 2, 25, 4, 0.05, 0.05]
   A_Inst,V_Inst,Omega_Inst=Instant_AmpOmega_Extraction_Sliding(a[0],a[1],50,0.1,5,para)
   print(A_Inst)
   print(Omega_Inst)
