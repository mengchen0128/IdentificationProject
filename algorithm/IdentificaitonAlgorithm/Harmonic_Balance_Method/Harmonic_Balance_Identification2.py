...
from algorithm.Harmonic_Balance_Method.DerivativeMatrix import DerivativeMatrix
from algorithm.Harmonic_Balance_Method.FourierSeriesFit import FourierSeriesFit


def Harmonic_Balance_Identification2():
    ...
    for q in range(0, N_omeg):
        ...
        F = FourierSeriesFit(t, f, omega_q[q], I)
        X = FourierSeriesFit(t, x, omega_q[q], I)
        Y = FourierSeriesFit(t, x ** 3, omega_q[q], I)
...
if __name__ == '__main__':
    Harmonic_Balance_Identification2()
