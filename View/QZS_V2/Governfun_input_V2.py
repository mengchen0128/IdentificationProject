...
class governfun_input_V2(QWidget):

    def __init__(self, para,*args, **kwargs):
        super(governfun_input_V2, self).__init__(*args, **kwargs)
    ...
    def create_button(self):
        ...
        open_file_button.setMaximumWidth(100)


        save_file_button=QPushButton("保存")
        save_file_button.setIcon(QtGui.QIcon(os.path.join('images', 'disk.png')))
        save_file_button.setIconSize(QtCore.QSize(24,24))
        save_file_button.setMaximumWidth(100)
